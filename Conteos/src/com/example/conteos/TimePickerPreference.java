...
public class TimePickerPreference extends DialogPreference {
	...
	/**
	 * M�todo que asocia la vista time_picker.xml al actual DialogPreference.
	 * �til al momento de mostrar el time_picker.xml al momento de abirse el dialogo
	 * y tambien �tila para capturar la hora seleccionada
	 */
	@Override
	protected void onBindDialogView( View vista ){
		...
		//el sgte m�todo retorna el valor x defecto
	...
	/**
	 * Al dar click en los botones aceptar o cancelar, se ejecuta este m�todo
	 */
	@Override
